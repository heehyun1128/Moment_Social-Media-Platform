  ...
  return (
    <div id="home">
      <video ref={videoRef} autoplay loop muted>
        <source
          src="https://aamomentbucket.s3.us-west-1.amazonaws.com/4763786-uhd_4096_2160_24fps.mp4"
          type="video/mp4"
        />
      </video>
      <div id="head-icon-div" className="slide-in-top">
        {sessionUser ? (
          <div id="home-logout">
        ...
        <NavLink
          ...
          to="/posts/all"
          class="button "
          style={{ fontSize: "22px", paddingTop: "0px !important" }}
        >
          DISCOVER
        </NavLink>
      </div>
      <div id="intro">
        ...
        <p style={{ color: "#c1cad9" }} className="text-focus-in_top">
          Welcome to Moment,
          <br />
          where every post is a cherished memory waiting to be shared. <br />
          Connect with friends and make moments
        </p>

        <ul className="actions ter slide-in-blurred-bottom">
          <li>
            <a
              href="#home-header"
